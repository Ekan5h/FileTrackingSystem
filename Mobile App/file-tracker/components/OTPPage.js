                        ...
                        <Button 
                            ...
                            onPress={async ()=>{
                                if(!(/^[a-zA-Z0-9+_\.-]+@[a-zA-Z0-9\.-]+\.[a-zA-Z]+$/.test(email))){
                                    this.dropDown.alertWithType('error', 'Enter email address', 'The provided email does not look like one');
                                    return 0;
                                }
                                setLoading(true);
                                ...
                                try{
                                  ...
                                  this.dropDown.alertWithType('error','Network Error','Some error occurred')
                                  setLoading(false);
                                  return 0;
                                }
                                if(error.error){
                                  this.dropDown.alertWithType('error','Server Error','Some error occurred');
                                  setLoading(false);
                                  return 0;
                                }
                                setLoading(false);
                                this.dropDown.alertWithType('success','OTP sent!','Check your email for OTP');
                                setEnterEmail(false);
                                setResend(false);
                                setTimeInterval(
                                    setInterval(()=>{
                ...
                { !enterEmail && (
                    <>
                        ...
                        <View style={{flexDirection:'row', flexWrap:'wrap'}}>
                            ...
                            <Text style={{fontSize:15, marginTop:9, marginLeft:90, color:'gray'}}>
                        ...
                        <Button 
                            ...
                            onPress={
                                async ()=>{
                                  ...
                                  if(match.match){
                                    this.dropDown.alertWithType('success','Authentication Successful','OTP matched successfully');
                                    setLoading(false);
                                    return 0;
                                  }
                                  this.dropDown.alertWithType('error','Authentication Unsuccessful','OTP does not match');
                                  setLoading(false);
                                  return 0;
                                }
                            }>
